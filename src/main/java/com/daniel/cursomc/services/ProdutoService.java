...
public class ProdutoService {
	...
	public Page<Produto> search(String nome, java.util.List<Integer> ids, Integer page, Integer linesPerPage, String orderBy, String direction) {
		PageRequest pageRequest = PageRequest.of(page, linesPerPage, Direction.valueOf(direction), orderBy);
		java.util.List<Categoria> categorias = categoriaRepository.findAllById(ids);
